<h2><a href="https://www.geeksforgeeks.org/problems/rahul-and-his-villa2019/1?page=2&category=Hash&sortBy=difficulty">Find the maximum area</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">You are given an array <strong>arr&nbsp;</strong>denoting the side length of the squares. You have to return the maximum area that can be formed.</span></p>
