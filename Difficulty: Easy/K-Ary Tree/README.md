<h2><a href="https://www.geeksforgeeks.org/problems/k-ary-tree1235/1?page=1&category=Tree&status=unsolved&sortBy=difficulty">K-Ary Tree</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Find the number of leaf nodes in a full <strong>k</strong>-ary tree of height <strong>m</strong>.<br>
